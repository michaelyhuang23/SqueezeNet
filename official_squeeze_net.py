...
class Graying(object):
    ...
    def __init__(self):
        super(Graying)
        self.grayer = transforms.Grayscale(3)
...
trans = transforms.Compose([transforms.ToTensor(),transforms.CenterCrop(224),Graying()])
...
model = squeezenet1_0(False, True).to(device)
